...
2. Ensure OpenCV native libraries can be resolved on your system (the build pulls `org.openpnp:opencv:4.9.0-0` and loads the packaged Windows binaries automatically).
